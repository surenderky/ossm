...
5) In case we need to skip additonal test then make sure to set IBM_SKIP="true" then we can copy sample/ibm_skip_istio_test.json file to /root/ and add skip respective test/subsuite to it.
