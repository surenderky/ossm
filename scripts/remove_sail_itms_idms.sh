...
oc delete -f ${SOURCE_ROOT}/jenkins-csb-declaration/resources/ocp/templates/olm/custom/mirrorSets/ibm/sail-e2e-registry-itms-idms.yaml
...
echo "All MCPs updated successfully."
    ...
    echo "Skipping setup as sail-e2e-required-images-registry-mirror ITMS and IDMS does not exists"
fi
