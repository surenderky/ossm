...
oc delete -f ${SOURCE_ROOT}/jenkins-csb-declaration/resources/ocp/templates/olm/custom/mirrorSets/ibm/istio-integration-registry-itms-idms.yaml
...
echo "All MCPs updated successfully."
    ...
    echo "Skipping setup as istio-integration-required-images-registry-mirror ITMS and IDMS does not exists"
fi
